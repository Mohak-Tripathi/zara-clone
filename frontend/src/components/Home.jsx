   ...
   <Link to="/login"><img
    ...
    /> </Link>
     <div className='bottom-nav'>
       < div >
           <a className='bottom-nav-a'href='#'>New</a>
       </ div >
          < div >
            <a className='bottom-nav-a' href='#'>ISLAND</a>  
          </ div >
          < div>
           <a className='bottom-nav-a'href='#'>SUITS</a>   
          </ div >
        < div >
             <a className='bottom-nav-a' href='#'>JOIN LIFE</a> 
        </ div >
      < div >
           <a className="bottom-nav-a" href='#'>ZARA ATHLETICS</a>
      </ div>
